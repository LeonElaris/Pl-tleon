...
async function initMongo() {
  ...
  try {
    ...
    console.log("⚠️ Mongo av: ", String(e?.message || e));
    db = null;
  }
}
await initMongo();
...
app.get("/version", (_req, res) => res.json({ app: "platleon", version: "1.1.0", node: process.version }));
app.get("/api/version", (_req, res) => res.json({ app: "platleon", version: "1.1.0" }));
